                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(fontSize: 8, color: kcPrimaryColor),
                    )
                  ],
                ),
              ),
...
Widget _buildShimmerCard() {
  return Shimmer.fromColors(
    baseColor:
        uiMode.value == AppUiModes.dark ? Colors.grey[700]! : Colors.grey[300]!,
    highlightColor:
        uiMode.value == AppUiModes.dark ? Colors.grey[300]! : Colors.grey[100]!,
    child: Container(
      height: 200,
